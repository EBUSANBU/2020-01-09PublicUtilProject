...
String sql = "select a.id, a.name from MeetingRoom a where 1=1 "  + sqlwhere + " order by id";
...
function getMeetingInfo(){
	...
	$.post("AjaxMeetingRoomPlan.jsp",{bywhat:$GetEle("bywhat").value,currentdate:$GetEle("currentdate").value,movedate:$GetEle("movedate").value,content:encodeURIComponent($GetEle("content").value),subids:$GetEle("subids").value,canEdit:$GetEle("canEdit").value},function(datas){
